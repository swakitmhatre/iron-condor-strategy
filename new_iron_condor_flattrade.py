...
# ====== USER CONFIGURATION ======
API_KEY = "c1ec547bd4ed438583185b850697ba7c"
API_SECRET = "2026.686da04d37814b4f86e0fb0287cfccbe14000955a3162480"
CLIENT_ID = "FT053224"
UID = "FT053224"
ACT_ID = "FT053224"
    ...
    try:
        ...
        if t in ("tk", "tf", "tkf", "tfk"):   # cover variants
            ...
            if pnl >= TARGET_PROFIT or pnl <= STOP_LOSS:
                #trigger_exit()
                logging.info(f"Target/Stoploss hit. Exiting Iron Condor...,MTM:{pnl:.2f}")
                #ws.close()
                JKEY = get_token()
